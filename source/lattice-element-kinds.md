...
A Fork element marks the start of an alternative branch for the beam or for X-rays or
...
Besides the `ForkP` documentation, see the [](#s:forking) section for more details.
